# IKERUSIKI Adaptive Boundary Address 窶� Formal Mathematical Basis
...
竊� Collision detection  
竊� Candidate-axis evaluation  
竊� Select  
竊� Address update  
竊� Collision re-evaluation  
竊� EXPAND only when the current candidate family is insufficient**

The document distinguishes three levels of claim:

1. **Proved finite-corpus properties** 窶� partition refinement, collision monotonicity, strict reduction under an effective axis, finite separating-axis existence, and finite convergence when admissible axes may expand.
2. **Implementation-dependent facts** 窶� the current demonstration uses `(distance, direction)` as one axis component and evaluates candidate axes according to unresolved-pair reduction, entropy, and axis size.
3. **Empirical observations** 窶� particular trajectories such as `4950 竊� 4 竊� 0` or `4950 竊� 6 竊� 0`.
...
## 2. Lemma 窶� Residue Equivalence of the Current Implementation
